...
export const FRESCHI_DB = [
  ...
  { nome: "Latte Fresco", testo: "alias: latte fresco intero, latte fresco parzialmente scremato, latte fresco scremato, latte crudo, latte di capra fresco, latte di pecora fresco, latte di bufala fresco, latte biologico fresco | formato: bottiglia, cartone | marchi: vari", sotto1: "Latticini", sotto2: "Latte", unit: "l" },
  ...
  { nome: "Uova di Quaglia", testo: "alias: uova quaglia, quail eggs | formato: vasetto, cartone | marchi: vari", sotto1: "Altri Freschi", sotto2: "Uova", unit: "pz" },
  { nome: "Cotechino", testo: "alias: cotechino fresco, cotechino precotto, cotechino modena IGP, zampone modena IGP, zampone fresco, zampone precotto | varianti: fresco, precotto | formato: pz, S/V | marchi: vari", sotto1: "Salumi", sotto2: "Cotechino", unit: "kg" },
  ...
  { nome: "Pane Fresco", testo: "alias: pane fresco, panini freschi, baguette fresca, filone fresco, pane casereccio, pane di grano duro, pane integrale fresco, pagnotta fresca, ciabatta fresca, focaccia fresca, grissini freschi | varianti: bianco, integrale, di grano duro, multicereali | origine: artigianale, industriale | formato: pz, sacchetto, cassetta", sotto1: "Altri Freschi", sotto2: "Pane Fresco", unit: "kg" },
  { nome: "Brioche Fresca", testo: "alias: brioche fresca, cornetto fresco, croissant fresco, pain au chocolat fresco, girella fresca, danubio fresco, treccia fresca | varianti: vuota, con crema, con marmellata, al cioccolato | formato: pz, vassoio", sotto1: "Altri Freschi", sotto2: "Pane Fresco", unit: "kg" },
  { nome: "Pasta di Pistacchio", testo: "alias: crema di pistacchio pura, pasta pistacchio pura, pure paste pistacchio | varianti: BIO, esteri, Bronte DOP | S/V", sotto1: "Altri Freschi", sotto2: "Paste di Frutta Secca", unit: "kg" },
  { nome: "Pasta di Nocciole", testo: "alias: crema di nocciole pura, pasta nocciole pura, pure paste nocciole | varianti: Piemonte IGP, tostate | S/V", sotto1: "Altri Freschi", sotto2: "Paste di Frutta Secca", unit: "kg" },
  { nome: "Pasta di Mandorle", testo: "alias: crema di mandorle pura, pasta mandorle pura, marzapane, mandorlata | varianti: BIO, pelate, tostate | S/V", sotto1: "Altri Freschi", sotto2: "Paste di Frutta Secca", unit: "kg" },
  { nome: "Strutto", testo: "alias: strutto di maiale, sugna, lardo sciolto, grasso di maiale | varianti: in vaschetta, in blocco | formato: vaschetta, panetto | marchi: vari", sotto1: "Altri Freschi", sotto2: "Grassi Animali", unit: "kg" },
