...
export const DISPENSA_DB = [
  ...
  { nome: "Purea Verdure", testo: "alias: purea di zucca, purea di patate, purea di piselli, purea di carote, purea di castagne, purea di ceci, purea di fagioli, vellutata di zucca, crema di zucca, crema di ceci, crema di fagioli, crema di castagne, passato di verdure | formato: barattolo, busta, tetrapak | marchi: Selecta, vari", sotto1: "Conserve", sotto2: "Ortaggi", unit: "kg" },
  ...
  { nome: "Carciofi Conserva", testo: "alias: carciofi sott'olio, carciofi al naturale, cuori di carciofo, cuori di carciofo sott'olio, fondi di carciofo, carciofi grigliati | varianti: interi, tagliati, sott'olio, al naturale | formato: vaso, barattolo, latta | marchi: Ortoc", sotto1: "Conserve", sotto2: "Ortaggi", unit: "kg" },
  ...
  { nome: "Funghi Secchi", testo: "alias: funghi porcini secchi, porcini secchi, funghi secchi misti, funghi essiccati, porcini essiccati, funghi dried, porcini dried | varianti: porcini, misti, ovuli | formato: busta, barattolo, vasetto | marchi: vari", sotto1: "Secchi", sotto2: "Funghi Secchi", unit: "kg" },
  { nome: "Funghi Conserva", testo: "alias: funghi sott'olio, porcini sott'olio, funghi trifolati, funghi al naturale, funghi in barattolo, funghi conservati, champignon al naturale, champignon sott'olio | formato: barattolo, vasetto, latta | marchi: vari", sotto1: "Conserve", sotto2: "Ortaggi", unit: "kg" },
  ...
  { nome: "Peperoni Grigliati", testo: "alias: peperoni grigliati in vasetto, peperoni arrostiti ristori, peperoni grigliati conserva, peperoni alla griglia | marchi: Ristori, Ortoc, Selecta | formato: vaso, barattolo, latta", sotto1: "Conserve", sotto2: "Ortaggi", unit: "kg" },
  ...
  { nome: "Confettura", testo: "alias: marmellata, confettura di frutta, confettura di fragola, confettura di lampone, confettura di albicocca, confettura di ciliegia, confettura di fico, confettura di mirtillo, confettura di arancia, confettura di pesca, confettura di prugna, marmellata di arance, marmellata di fragole, composta di frutta, composta di mele | formato: vaso, vasetto 110g | BIO | marchi: MonS, Gli Indispensabili", sotto1: "Conserve", sotto2: "Dolci", unit: "kg" },
  ...
  { nome: "Condimento Tartufo", testo: "alias: cond. evo tartufo, cond.evo tartufo, condimento al tartufo, olio al tartufo, olio tartufo, condimento tartufo bianco, condimento tartufo nero, cond.tartufo | formato: bottiglia 250ml, 500ml | marchi: Selecta, MARR", sotto1: "Condimenti", sotto2: "Tartufo", unit: "l" },
  ...
  // ── FRUTTA SECCA ─────────────────────────────────────────────────────────────
  { nome: "Nocciole", testo: "alias: nocciole tostate, nocciole intere, nocciole sgusciate, nocciole pelate, nocciole Piemonte IGP, nocciole in guscio | varianti: tostate, crude, pelate, intere | BIO | formato: busta, sacchetto, scatola", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Granella Nocciole", testo: "alias: granella di nocciole, nocciole granella, nocciole in granella, granella nocciola | formato: busta, sacchetto | BIO", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Pistacchi", testo: "alias: pistacchi sgusciati, pistacchi interi, pistacchi di Bronte DOP, pistacchi tostati, pistacchi salati | varianti: sgusciati, interi, tostati, crudi | BIO | formato: busta, sacchetto, scatola", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Granella Pistacchio", testo: "alias: granella di pistacchio, pistacchio granella, pistacchi in granella, granella pistacchi | formato: busta, sacchetto | BIO | Bronte DOP", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Mandorle", testo: "alias: mandorle pelate, mandorle intere, mandorle tostate, mandorle in scaglie, mandorle a lamelle, mandorle sgusciate | varianti: pelate, intere, tostate, a lamelle, in scaglie, crude | BIO | formato: busta, sacchetto, scatola", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Granella Mandorle", testo: "alias: granella di mandorle, mandorle granella, mandorle in granella, mandorle tritate | formato: busta, sacchetto | BIO", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Pinoli", testo: "alias: pinolo, pinoli italiani, pinoli cinesi | formato: busta, sacchetto | BIO", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Noci", testo: "alias: noci sgusciate, noci in guscio, noci tostate, gherigli di noce | varianti: sgusciate, in guscio, tostate | formato: busta, sacchetto, scatola", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Anacardi", testo: "alias: anacardi tostati, anacardi crudi, anacardi salati | formato: busta, sacchetto", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Uvetta", testo: "alias: uva sultanina, uvetta passa, uva passa, raisins | formato: busta, sacchetto", sotto1: "Secchi", sotto2: "Frutta Secca", unit: "kg" },
  { nome: "Farina Frutta Secca", testo: "alias: farina di nocciole, farina di mandorle, farina di pistacchio, farina di noci | varianti: nocciole, mandorle, pistacchio, noci | BIO | formato: busta, sacchetto", sotto1: "Secchi", sotto2: "Farina", unit: "kg" },
  ...
  { nome: "Farina", testo: "alias: farina di mais, farina di ceci, farina di castagne, farina di riso, farina di grano saraceno, farina di farro, farina di kamut, farina di avena, farina tipo 00, farina 0, farina integrale, farina di forza, semola di grano duro, farina per pizza, farina per pane, farina per dolci | varianti: tipo 00, 0, 1, 2, integrale, di forza W220, W310, semola, farro, avena, ceci, mais, riso, grano saraceno, mandorle, nocciole, Kamut, 5 cereali | BIO, macinate a pietra | formato: sacco 1kg, 5kg, 25kg | marchi: Selecta", sotto1: "Secchi", sotto2: "Farina", unit: "kg" },
  ...
  { nome: "Brodo Knorr", testo: "alias: brodo knorr dell'orto, brodo knorr classico, brodo granulare knorr, dado knorr, brodo star, brodo buitoni | varianti: verdure, pollo, manzo, orto | formato: busta, barattolo, pz | marchi: Knorr, Star, Buitoni", sotto1: "Secchi", sotto2: "Brodi", unit: "kg" },
  ...
  { nome: "Panatura", testo: "alias: macinato per impanare, fette per impanare, pane per impanare, macinato di fette, pancarrè macinato, mollica macinata, pan grattato, panko, fette pancarrè | varianti: classica, panko, integrale | formato: busta, sacchetto | marchi: vari", sotto1: "Secchi", sotto2: "Panatura", unit: "kg" },
  ...
  { nome: "Spezie", testo: "alias: cipolla in polvere, aglio in polvere, aglio granulare, cipolla granulare, basilico essiccato, basilico secco, origano secco, rosmarino secco, timo secco, salvia secca, prezzemolo secco, erbe di provenza, mix spezie, miscela spezie | varianti: pepe nero, pepe bianco, pepe rosa, pepe verde, pepe Sichuan, curcuma, paprika, cumino, coriandolo, noce moscata, cannella, chiodi garofano, zafferano, anice stellato, cardamomo, curry, masala, Ras El Hanout | intera, macinata | formato: barattolo, busta, vasetto | marchi: Speziale, Thiercelin 1809, Selecta", sotto1: "Secchi", sotto2: "Spezie", unit: "kg" },
  { nome: "Cioccolato", testo: "alias: cioccolato fondente, cioccolato al latte, cioccolato bianco, cioccolato di copertura, couverture fondente, couverture al latte, cioccolato 70%, cioccolato 60%, cioccolato 80%, cacao in polvere, cacao amaro, cacao zuccherato, burro di cacao, pasta di cacao, gocce di cioccolato, granella di cioccolato, scaglie di cioccolato | varianti: fondente, al latte, bianco, copertura | formato: tavoletta, busta, blocco, gocce | marchi: Valrhona, Callebaut, Cacao Barry, Selecta", sotto1: "Secchi", sotto2: "Cioccolato e Cacao", unit: "kg" },
  { nome: "Gelatina", testo: "alias: gelatina in fogli, gelatina in polvere, colla di pesce, gelatina alimentare, agar agar, pectina, carragenina | varianti: in fogli, in polvere, agar agar | formato: busta, scatola | marchi: Selecta, vari", sotto1: "Secchi", sotto2: "Addensanti", unit: "kg" },
  { nome: "Glucosio", testo: "alias: sciroppo di glucosio, glucosio in polvere, destrosio, zucchero invertito, trimoline, sciroppo di fruttosio | varianti: liquido, in polvere | formato: secchio, busta, barattolo | marchi: Selecta", sotto1: "Secchi", sotto2: "Zucchero", unit: "kg" },
  ...
  { nome: "Bibite", testo: "alias: bevanda gassata, soft drink, coca cola, coca cola zero, coca cola zero sleek, coca cola latt, coca cola pet, fanta, fanta orange, fanta sleek, sprite, sprite zero, pepsi, chinotto, aranciata, limonata, lemonsoda lattina, chinotto s.benedetto | varianti: Coca Cola, Coca Cola Zero, Fanta, Sprite, Pepsi, chinotto, aranciata, limonata, tonica | formato: lattina 33cl, PET 1,5L, CT 24x33cl | marchi: Coca Cola, Schweppes, S.Benedetto, Lemonsoda", sotto1: "Bevande analcoliche", sotto2: "Bibite", unit: "l" },
  { nome: "Succo Pomodoro", testo: "alias: succo di pomodoro, passata di pomodoro da bere, tomato juice, pompelmo succo, succo di pompelmo | formato: bottiglia, brick, lattina | marchi: Yoga, Granini, vari", sotto1: "Bevande analcoliche", sotto2: "Succhi", unit: "l" },
  { nome: "Succo Frutta", testo: "alias: succo di frutta, succo di arancia, succo di pesca, succo di pera, succo di mela, succo di ananas, succo di pompelmo, succo di albicocca, succo di fragola, succo di limone, succo di lime, succo di mango, succo di maracuja, nettare di frutta, nettare di albicocca, nettare di pesca, succo polpa, smoothie frutta, ACE, centrifuga | formato: brick 200ml, bottiglia 1L, CT 8x1L | marchi: GDS, Boero, Granini, Yoga", sotto1: "Bevande analcoliche", sotto2: "Succhi", unit: "l" },
  { nome: "The", testo: "alias: tè, ice tea, lipton ice tea limone, lipton ice tea pesca, lipton ice tea verde, estathe limone, estathe pesca, bevanda al tè, ice tea limone, ice tea pesca, ice tea al limone, ice tea alla pesca, the freddo limone, the freddo pesca | varianti: limone, pesca, verde | formato: lattina 33cl, PET 1,5L, brick 200ml | marchi: Estathé, Lipton, S.Benedetto", sotto1: "Bevande analcoliche", sotto2: "Bibite", unit: "l" },
  { nome: "Sciroppo", testo: "alias: sciroppo bar, sciroppo di fragola, sciroppo di lampone, sciroppo di menta, sciroppo di arancia, sciroppo di limone, sciroppo di amarena, sciroppo di pesca, sciroppo di maracuja, sciroppo di mango, sciroppo al limone, sciroppo alla fragola, sciroppo granatina, latte di mandorle, sciroppo di zucchero, mixyfruit | formato: bottiglia 750ml, 1,25kg, 1,3kg | marchi: Fabbri, Toschi, Boero", sotto1: "Bevande analcoliche", sotto2: "Sciroppi", unit: "l" },
  { nome: "Latte UHT", testo: "alias: latte uht intero, latte uht parzialmente scremato, latte uht scremato, latte a lunga conservazione, latte brik, latte in tetrapak, latte senza lattosio | varianti: intero, parzialmente scremato, scremato, senza lattosio | formato: brick 1L, brick 500ml, CT 6x1L | marchi: vari", sotto1: "Conserve", sotto2: "Latticini Conserva", unit: "l" },
  { nome: "Latte Condensato", testo: "alias: latte condensato zuccherato, condensed milk, latte in polvere, latte intero in polvere | varianti: condensato, in polvere | formato: latta, busta, barattolo", sotto1: "Conserve", sotto2: "Latticini Conserva", unit: "kg" },
  { nome: "Bevanda Soia", testo: "alias: latte di soia, latte di avena, latte di riso, latte di mandorla, latte di cocco, latte di farro, bevanda avena, bevanda vegetale, latte vegetale, latte senza lattosio | varianti: soia, avena, mandorla, riso, cocco | formato: bottiglia 1L, brick 500ml | marchi: Alpro, Orasi", sotto1: "Bevande analcoliche", sotto2: "Bevande Vegetali", unit: "l" },
  ...
  { nome: "Vino da Cucina", testo: "alias: vino per cucinare, vino sfuso, marsala cucina, marsala secco, marsala dolce, vino bianco da cucina, vino rosso da cucina, vino bianco cucina, vino rosso cucina, vino brik cucina | varianti: bianco, rosso, Marsala, brik | formato: brik, bottiglia, fusto | marchi: vari", sotto1: "Bevande alcoliche", sotto2: "Vino", unit: "l" },
  ...
  { nome: "Baileys", testo: "alias: baileys irish cream, baileys original, baileys cream | varianti: original, espresso | formato: bottiglia 70cl, 1L, 100cl | marchi: Baileys", sotto1: "Superalcolici", sotto2: "Liquore", unit: "l" },
  { nome: "Liquore", testo: "alias: limoncello, liquore al limone, arancello, liquore all'arancia, fragolino, liquore alla fragola, liquore al mirtillo, liquore alla pesca, nocino, sambuca, amaretto, liquore al maracuja, passoa, cointreau, grand marnier, triple sec, midori | varianti: limoncello, arancello, fragolino, nocino, sambuca, amaretto | formato: bottiglia 70cl, 1L | marchi: vari", sotto1: "Superalcolici", sotto2: "Liquore", unit: "l" },
  ...
  { nome: "CIF", testo: "alias: cif vetri, cif multiuso, cif bagno, cif cucina, cif anticalcare, cif sgrassatore, cif professionale, cif prof, cif crema | varianti: vetri, multiuso, bagno, cucina | formato: flacone 750ml, 1L | marchi: CIF", sotto1: "Detersivi", sotto2: "Pulizia Ambienti", unit: "l" },
  { nome: "Piatti Concentrato", testo: "alias: piatti concentrato marr, detergente piatti concentrato, detersivo piatti concentrato, tabs piatti, pastiglie piatti, compresse lavastoviglie | formato: tanica, kg, confezione | marchi: MARR, vari", sotto1: "Detersivi", sotto2: "Pulizia Cucina", unit: "kg" },
